...
#'
#' @description Pass this function either 1) a labeled factor or 2) a 
#' data frame and also a factor in the frame, and it will return a 
#' `janitor`-style table.  Use subset = TRUE if you are making a report on 
