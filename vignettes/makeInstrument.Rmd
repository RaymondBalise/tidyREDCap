...
The instruments that are not assessed every day appear as entirely blank questionnaires when the data is exported.  For example, the NCI is shown as missing for the Day 1, Day 2 an Day 3 anxiety assessment visits where it was not administered. 
