...
REDCap exports longitudinal projects with one record (a line of data) per assessment (typically 1 line per day).  This works well when every instrument/questionnaire is given at every assessment. Still, for projects that have different instruments/questionnaires provided on different days, REDCap exports empty values (represented by the value `NA` in R).
