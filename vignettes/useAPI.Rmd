...
If you do this anybody who gets a copy of you code will be able to access your REDCap project.  Also whenever your run this line of code the API token will be saved into your R history files.
...
Create a name for your API key and add a line like this to your .Renviron file:
