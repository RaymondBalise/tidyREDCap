...
<span class="customIndent">Assertion on 'token' failed: Must comply to pattern '^.{1,}$'.</span>
</div>
</li>
...
<span class="customIndent">The token is not a valid 32-character hexademical value.</span>
</div>
</li>

The API key is invalid. Try to copy and paste it again. <b><i>Restart R.</i></b>
...
The API key is not associated with a REDCap project. Try to copy and paste it again. <b><i>Restart R.</i></b>
