...
After running the above code we get four tables from the REDCap project (See Figure 2).
\

![](./global.jpg)
<p class=caption id="fig2">
Figure 2 </p>

\

Notice that each repeat of the HAM-A is its own record (See Figure 3).

![](./hama.jpg)
<p class=caption id="fig3">
Figure 3 </p>
\
